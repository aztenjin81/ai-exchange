# Full source dump (part 2 of 2)

**Generated:** 2026-05-18 16:42:26 MST
**File:** kalshi-crypto-prod (661 lines, 29689 bytes)
...
MIN_EDGE_CENTS = 6              # Loosened from 8 on 2026-05-18 after zero
                                # trade volume overnight. 8c excluded the
                                # profitable 6-9c bucket (74 trades, 39% hit,
                                # +$487) along with the 3-6c loser bucket
                                # (93 trades, 15% hit, -$262). At 6c we
                                # capture the profitable bucket and still
                                # exclude the loser.
                                # See ~/hermes-vault/hermes/2026-05-18-kalshi-coin-pnl-30d.md
MIN_EDGE_RATIO = 0.15           # Edge / executable ask must clear this
MIN_CONFIDENCE = 0.30           # Reverted from 0.15 on 2026-05-18 alongside
                                # the MIN_EDGE_CENTS revert. Low-confidence
                                # trades drove the recent P&L drawdown.
